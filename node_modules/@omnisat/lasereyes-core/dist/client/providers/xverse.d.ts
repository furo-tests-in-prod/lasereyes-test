...
import { ProviderType, NetworkType, LaserEyesStoreType, SignMessageOptions } from '../..';
...
export default class XVerseProvider extends WalletProvider {
    ...
    signMessage(message: string, { toSignAddress, protocol }: SignMessageOptions): Promise<string>;
