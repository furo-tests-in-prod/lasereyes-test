import { ContentType, NetworkType, Protocol, ProviderType, SendArgs, SignMessageOptions } from '@omnisat/lasereyes-core';
export type LaserEyesContextType = {
    ...
    signMessage: (message: string, toSignAddressOrOptions?: string | SignMessageOptions) => Promise<string>;
